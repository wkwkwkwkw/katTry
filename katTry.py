...
helpMessage =""" Katro Menu beta X¹ 􀔃􀄆red check mark􏿿

􀔃􀅕red arrow right􏿿 Command Public

✒[Bot?]  Cek Account Bot
✒[Id Group] Cek Group Id
✒[Ginfo] Group Info
✒[Mid kat] Cek All mid Bot
✒[kat 1/2/3/4] Cek Mid Bot
✒[Respon] Respon Bot
✒[Speedbot] Cek Speed Bot
✒[Banlist]  Cek Ban List
✒[Gn namagroup] Change name Group
...
✒[namabot join] Invite Bot
✒[Bye namabot]  Leave Bot
"""
    ...
    try:
        ...
        if op.type == 15:
            if op.param2 in Bots:
                return
            ki.sendText(op.param1, "Good Bye Mother fucker🖕")
                ...
                cl.sendText(msg.to,"====[List Group]====\n"+ h +"Total Group :" +str(len(gid)))          
                    ...
                    if msg.from_ in admin:
						          if msg.to in wait2['readPoint']:
							            ...
							            cl.sendText(msg.to, "|•People who's read•|%s\n|•This people no have brain•|\n\nTime to deploy lastseen（#＾ω＾）\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
						          else:
